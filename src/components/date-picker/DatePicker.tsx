      ...
      <Popover>
        <PopoverTrigger>
          <div
            id="date-input"
            className={cn(
              'w-full flex items-center gap-2  h-11 px-2 transition-all cursor-pointer',
              ' focus:ring-2 focus:ring-primary/20 text-white/80',
              !date && 'text-foreground',
              `${!isDeadline ? 'deadline pointer-events-none cursor-not-allowed ' : 'input-current-task'}`,
            )}
          >
            <svg
              width="31"
            ...
            >
              <path
                ...
                fill={`${!isDeadline ? 'gray' : 'white'}`} //"white"
              />
              <path
                ...
                fill={`${!isDeadline ? 'gray' : 'white'}`} //fill="white"
              />
              <path
